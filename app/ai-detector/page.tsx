...
import { Logo, Footer } from "@/lib/shared-components";
...
function StatCard({
  ...
  return (
    <div
      className={`rounded-xl border px-4 py-3 text-center ${colors[color]}`}
    >
...
export default function AIDetectorPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-900">
      ...
      {/* Hero Section */}
      <section className="border-b border-gray-800 bg-gray-950 py-12 lg:py-16">
        <div className="mx-auto max-w-4xl px-6 text-center">
          ...
          <div className="mx-auto mt-8 flex max-w-md justify-center gap-4">
            <StatCard value="99%" label="Accuracy" color="emerald" />
            <StatCard value="10M+" label="Scans" color="blue" />
      ...
      <section className="py-10 lg:py-14">
        <div className="mx-auto max-w-4xl px-6">
          ...
          {/* Input Card */}
          <div className="rounded-2xl border border-gray-800 bg-gray-800/50 p-6 shadow-lg">
            {/* Textarea */}
            <div className="relative">
              <textarea
                ...
                rows={10}
                disabled={isLoading}
                className="block w-full resize-none rounded-xl border border-gray-700 bg-gray-900 px-4 py-4 text-sm text-white transition-all placeholder:text-gray-500 focus:border-emerald-500 focus:outline-none focus:ring-4 focus:ring-emerald-500/20 disabled:cursor-not-allowed disabled:opacity-60"
              />

              {/* Character counter */}
              <div className="absolute bottom-3 right-3 rounded-md bg-gray-800 px-2 py-1 text-xs font-medium text-gray-400">
            ...
            {/* Error */}
            {error && (
              <div className="mt-4 rounded-lg border border-red-500/30 bg-red-500/20 px-4 py-3 text-sm text-red-400">
                {error}
              </div>
            )}
          ...
          {detectionResult && activeTab === "detect" && (
            <div className="mt-8 space-y-6">
              ...
              <div className="rounded-2xl border border-gray-800 bg-gray-800/50 p-6">
                ...
                {/* Legend */}
                <div className="mt-6 flex flex-wrap items-center justify-center gap-4 border-t border-gray-700 pt-4">
                  ...
                  <div className="flex items-center gap-2 text-xs">
                    <span className="h-3 w-3 rounded bg-yellow-500/20 border border-yellow-500/30" />
      ...
      {!detectionResult && !rewriteResult && (
        <section className="border-t border-gray-800 bg-gray-950 py-14">
